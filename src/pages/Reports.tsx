      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
        ...
        <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm flex items-center gap-4">
          ...
          <div>
            ...
            <h3 className="text-2xl font-black">${stats.monthlyRevenue}</h3>
          </div>
        </div>
        <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm flex items-center gap-4">
        ...
        <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm flex items-center gap-4">
          ...
          <div>
            ...
            <h3 className="text-2xl font-black">${stats.totalDue}</h3>
          </div>
        </div>
      </div>
        ...
        <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm">
          ...
          <div className="space-y-4">
            <div className="flex justify-between items-center py-2 border-b border-slate-100">
              ...
              <span className="font-bold">${stats.totalPaid}</span>
            </div>
            <div className="flex justify-between items-center py-2 border-b border-slate-100">
              <span className="text-sm text-slate-600">Total Outstanding Dues</span>
              <span className="font-bold text-rose-600">${stats.totalDue}</span>
            </div>
          </div>
        </div>
        <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm">
